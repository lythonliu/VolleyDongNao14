package com.example.administrator.volleydongnao14.http.download.interfaces;


import com.example.administrator.volleydongnao14.http.download.DownloadRecord;
...
public interface IDownloadServiceCallback {
    ...
    void onCurrentSizeChanged(DownloadRecord downloadRecord, double downloadLength, long speed);
